...
extern const uint32_t mimophytbl_info_sz_rev0,
...
extern const uint32_t mimophytbl_info_sz_rev3,
		 mimophytbl_info_sz_rev3_volatile,
		 mimophytbl_info_sz_rev3_volatile1,
		 mimophytbl_info_sz_rev3_volatile2,
		 mimophytbl_info_sz_rev3_volatile3;

extern const uint32_t noise_var_tbl_rev3[];

extern const struct phytbl_info mimophytbl_info_rev7[];

extern const uint32_t mimophytbl_info_sz_rev7;

extern const uint32_t noise_var_tbl_rev7[];

extern const struct phytbl_info mimophytbl_info_rev16[];

extern const uint32_t mimophytbl_info_sz_rev16;
